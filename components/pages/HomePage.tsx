...
const FEATURES = [
  {
    ...
    icon: <Search size={24} />,
    title: "Trash Scanner",
    desc: "Paste any Solana, Ethereum, or Base address. Six live signals — holder concentration, deployer history, honeypot detection, and more. Risk score in seconds.",
    badge: "LIVE",
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-mono-jn font-black text-[10px] px-2 py-0.5 rounded"
                ...
                <div className="flex-shrink-0">
                  <Link href="/scan" className="btn-primary text-sm whitespace-nowrap">
                    Run a Scan <ArrowRight size={14} />
                  </Link>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-8 mb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://github.com/JanitorNetwork/janitor-network" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
                className="p-2 border border-[var(--border-faint)] hover:border-[var(--border-subtle)] transition-colors"
                style={{ borderRadius: 4 }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="var(--text-faint)">
